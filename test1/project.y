...
%token int_const char_const float_const int_id float_id char_id id string enumeration_const storage_const type_const qual_const struct_const enum_const DEFINE
...
assignment_exp				: conditional_exp {$$ = $1;}
							| unary_exp assignment_operator assignment_exp {printf("\n\nEntered\n\n");  checkAssign($1,$3);}			
							;
